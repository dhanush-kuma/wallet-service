...
('00000000-0000-0000-0000-000000000002', 'Revenue Diamond', NULL, 2, 0),
...
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Eren Diamond Wallet', 'e1e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e1e1', 2, 100)
ON CONFLICT (id) DO NOTHING;

-- if you want to uncomment the transaction of redeem 10, before running seed.sql for first time, increase revenue diamond wallet balance by 0 + 10 = 10 and reduce eren diamond wallet by 100 - 10 = 90
...
('a1111111-1111-1111-1111-111111111151', 'd1111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000000', 'debit', 1000),
('a1111111-1111-1111-1111-111111111121', 'd1111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'credit', 1000),

('a1111111-1111-1111-1111-111111111131', 'd2222222-2222-2222-2222-222222222222', '00000000-0000-0000-0000-000000000001', 'debit', 100),
('a1111111-1111-1111-1111-111111111141', 'd2222222-2222-2222-2222-222222222222', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'credit', 100)
ON CONFLICT (id) DO NOTHING;
